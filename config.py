...
def prepare_tsp_config(show=True, jupyter=False):
    ...
    parser.add_argument('--batch_size', type=int, default=20, help='batch size for modeling')
    ...
    parser.add_argument('--num_test', type=int, default=20, help='number of test cases')
    parser.add_argument('--start_index', type=int, default=0, help='starting point')
    parser.add_argument('--device', type=str, default='cpu', help='computation device gpu/cpu')
